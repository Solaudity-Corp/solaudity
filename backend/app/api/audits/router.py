...
def _raise_service_error(exc: Exception) -> None:
    ...
    if isinstance(exc, service.AuditForbiddenError):
...
def get_audit(
    ...
    try:
        return service.get_audit(session, audit_id, current_user.id)
    except Exception as exc:  # pragma: no cover - centralized error mapping
        _raise_service_error(exc)
...
def list_audit_attachments(
    ...
    try:
        return service.list_audit_attachments(session, audit_id, current_user.id)
    except Exception as exc:  # pragma: no cover - centralized error mapping
        _raise_service_error(exc)
...
def create_audit(
    ...
    try:
        return service.create_audit(session, payload, current_user.id)
    except Exception as exc:  # pragma: no cover - centralized error mapping
        _raise_service_error(exc)
...
def update_audit(
    ...
    try:
        return service.update_audit(session, audit_id, payload, current_user.id)
    except Exception as exc:  # pragma: no cover - centralized error mapping
        _raise_service_error(exc)
...
def set_audit_pin(
    ...
    try:
        return service.set_audit_pin(session, audit_id, payload, current_user.id)
    except Exception as exc:  # pragma: no cover - centralized error mapping
        _raise_service_error(exc)
...
def mark_audit_opened(
    ...
    try:
        return service.mark_audit_opened(session, audit_id, payload, current_user.id)
    except Exception as exc:  # pragma: no cover - centralized error mapping
        _raise_service_error(exc)
...
def delete_audit(
    ...
    try:
        service.delete_audit(session, audit_id, current_user.id)
